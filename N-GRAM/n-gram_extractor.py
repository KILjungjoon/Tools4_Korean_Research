...
if __name__=='__main__':
    ...
    g.save('저장경로_1gram.txt', uni_gram)
    g.save('저장경로_2gram.txt', bi_gram)
    g.save('저장경로_3gram.txt', tri_gram)
    g.save('저장경로_4gram.txt', four_gram)
    g.save('저장경로_5gram.txt', five_gram)
    g.save('저장경로_6gram.txt', six_gram)
